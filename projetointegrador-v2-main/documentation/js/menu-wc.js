...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">projeto-integrador-v2 documentation</a>
                </li>
                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-51c8377b38838f84a4214a34a281a8c0"' : 'data-target="#xs-components-links-module-AppModule-51c8377b38838f84a4214a34a281a8c0"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-51c8377b38838f84a4214a34a281a8c0"' :
                                            'id="xs-components-links-module-AppModule-51c8377b38838f84a4214a34a281a8c0"' }>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/UteisComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">UteisComponent</a>
                                            </li>
                                        </ul>
                                    </li>
                            </li>
